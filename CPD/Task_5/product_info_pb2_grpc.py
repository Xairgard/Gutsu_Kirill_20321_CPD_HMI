...
class ProductInfoStub(object):
    ...
    def __init__(self, channel):
        ...
        self.addProduct = channel.unary_unary(
                '/productinfo.ProductInfo/addProduct',
        ...
        self.delProduct = channel.unary_unary(
                '/productinfo.ProductInfo/delProduct',
                request_serializer=product__info__pb2.ProductDel.SerializeToString,
...
def add_ProductInfoServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'delProduct': grpc.unary_unary_rpc_method_handler(
                    servicer.delProduct,
                    request_deserializer=product__info__pb2.ProductDel.FromString,
                    response_serializer=product__info__pb2.DeleteResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'productinfo.ProductInfo', rpc_method_handlers)
...
class ProductInfo(object):
    ...
    def addProduct(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/productinfo.ProductInfo/addProduct',
    ...
    def getProduct(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/productinfo.ProductInfo/getProduct',
    ...
    def delProduct(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/productinfo.ProductInfo/delProduct',
            product__info__pb2.ProductDel.SerializeToString,
